function tail_node=next_state_pair_class(root_node,sequence_pair,TPN)
...
if ~isempty(trans_relation_A)
    [A_h,b_h]=Basis_Trans2(trans_relation_A, A, b);
    for i=1:size(A_h,1)
        ineq=A_h(i,:)*trans_relation_b*[h_1,h_2]'<=b_h(i,:);
